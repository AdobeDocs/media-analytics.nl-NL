---
title: Details van de telefoongesprek testen
description: Dit onderwerp details de vraag u moet maken om uw implementatie te bevestigen.
...
### Aanroep van Adobe Analytics (AppMeasurement) {#aa-start-call}
...
### Standaardmetagegevens in aanroep van Adobe Analytics (AppMeasurement) {#std-metadata-aa}
...
### Aanroep van Adobe Analytics (AppMeasurement) en Ad Start {#aa-ad-start-call}
...
### Standaardmetagegevens in aanroep van Adobe Analytics (AppMeasurement) en Start {#std-metadata-aa-ad-start}
...
### Aangepaste metagegevens in Adobe Analytics (AppMeturement) en aanroep starten {#custom-metadata-aa-ad-start}
...
### Media Analytics (heartbeats) Adobe Analytics en start call {#ma-aa-ad-start-call}
...
### Media Analytics (heartbeats) Adobe Analytics en volledige oproep {#ma-aa-ad-complete-call}
