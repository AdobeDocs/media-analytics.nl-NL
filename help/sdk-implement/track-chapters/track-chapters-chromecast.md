---
title: Hoofdstukken en segmenten bijhouden op Chromecast
description: Dit onderwerp beschrijft het uitvoeren hoofdstuk en segment het volgen gebruikend Media SDK op Chromecast.
...
1. Volg de `ChapterStart` gebeurtenis om het afspelen van het hoofdstuk te starten: [trackEvent](https://adobe-marketing-cloud.github.io/media-sdks/reference/chromecast/ADBMobile.media.html#.trackEvent)
...
1. Als het afspelen van het hoofdstuk niet is voltooid omdat de gebruiker het hoofdstuk heeft overgeslagen (bijvoorbeeld als de gebruiker buiten de hoofdstukgrens zoekt), moet u de `ChapterSkip` gebeurtenis volgen: [trackEvent](https://adobe-marketing-cloud.github.io/media-sdks/reference/chromecast/ADBMobile.media.html#.trackEvent)
