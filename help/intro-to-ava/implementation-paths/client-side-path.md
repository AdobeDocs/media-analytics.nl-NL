...
Als Media Analytics het bedoelde pad is, raadpleegt u [Implementatie van SDK voor media](/help/sdk-implement/setup/setup-overview.md) en [Media Collection API.](/help/media-collection-api/mc-api-overview.md)
