...
Deze parameter is niet alleen nodig voor het genereren van MCID wanneer dat niet is opgegeven, maar wordt ook gebruikt als de waarde voor de uitgevers-id (op basis waarvan Media Analytics uitvoert [overeenkomende federatieregel.](/help/federated-analytics.md))
