...
Deze variabelen worden gebruikt om advertentie-informatie samen met de openAd methode te verzenden. Zie [ VAST Video en het Volgen.](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html)
