...
| `Media.close` | **Syntaxis:** <br/><br/> `s.Media.close(mediaName)` <br/><br/>Hiermee wordt de verzameling van videogegevens beëindigd en wordt informatie naar Adobe-servers voor gegevensverzameling verzonden. Roep deze methode aan het einde van de video aan. Deze methode heeft de volgende parameter: <br/><br/> **mediaName:** De naam van de video. Dit moet overeenkomen met de naam die in wordt gebruikt `Media.open`. |
