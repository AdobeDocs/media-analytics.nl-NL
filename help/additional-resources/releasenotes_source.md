...
---
# Opmerking bij release streamingmedia - brontekst

De volgende inhoud is gekopieerd uit de opmerkingen bij de release Experience Cloud. Deze wordt verplaatst naar de nieuwe opmerkingen voor het streamen van media-items.
...
| ----------- | ---------- | ---------- | --------- |
| Januari | <a href="/docs/analytics-learn/tutorials/media-analytics/measuring-media-analytics/media-playback-time-spent-panel.html?lang=en">Deelvenster Tijd van afspelen van media</a> | Video | Leer hoe mediagebruikers met het deelvenster Tijd voor afspelen van media hun viewer kunnen begrijpen op basis van de hoeveelheid tijd die ze de dag over een gekozen korreligheid hebben bekeken. |
